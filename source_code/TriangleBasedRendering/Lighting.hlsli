...
float3 LambertBRDF(float3 lightDir, float3 lightPos, float3 albedo, float3 normal, float3 viewDir, float3 specular, float gloss)
{


	return max(0, dot(normal, lightDir))*albedo;
}